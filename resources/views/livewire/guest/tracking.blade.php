        ...
        <section class="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8">
            ...
            @if($booking->booking_pdf_path)
                <div class="mt-10 flex flex-col sm:flex-row gap-3">
                    <a href="{{ Storage::url($booking->booking_pdf_path) }}" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-white px-5 py-2.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50">
                    ...
                    @if($booking->status === 'approved' && $booking->approval_pdf_path)
                        <a href="{{ Storage::url($booking->approval_pdf_path) }}" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700">
